...
int main() {
    ...
    std::cout << limit_db.GetData("key") << std::endl; // 1-й раз — реальные данные
    std::cout << limit_db.GetData("key") << std::endl; // 2-й раз — реальные данные
    std::cout << limit_db.GetData("key") << std::endl; // дальше — "error"
